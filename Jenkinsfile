...
"""
                    ...
                    sh 'ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@3.110.159.125 "kubectl apply -f -" < deployment.yaml'
                    sh 'ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@3.110.159.125 "kubectl apply -f -" < service.yaml'
                }
            }
        }
    }
